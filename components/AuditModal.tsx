      ...
      <div
        className={`relative max-w-4xl w-full max-h-[88vh] flex flex-col rounded-[36px] border shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 ${
          isDark
            ...
            : 'bg-[#FFFBF5] border-[#FDE8CD] text-zinc-900 shadow-[#EA580C]/10'
        }`}
      >
        {/* Header */}
        <div className="px-8 py-6 border-b border-zinc-200 dark:border-white/10 flex items-center justify-between gap-4 shrink-0 bg-gradient-to-r from-[#EA580C]/10 via-transparent to-[#D4FF00]/10">
          <div className="flex items-center gap-3.5">
            <div className="w-12 h-12 rounded-2xl bg-[#EA580C] text-white flex items-center justify-center shadow-lg shadow-[#EA580C]/30 shrink-0">
        ...
        <div className="p-8 overflow-y-auto space-y-8 custom-scrollbar">
          {/* Executive Summary */}
          <div className={`p-6 rounded-3xl border ${isDark ? 'bg-[#18181B] border-white/5' : 'bg-white border-[#FDE8CD] shadow-sm'}`}>
            <h4 className="text-sm font-black uppercase tracking-widest text-[#EA580C] dark:text-[#D4FF00] mb-3">
              ...
              {[
                ...
                <div
                  ...
                  className={`p-5 rounded-2xl border transition-all ${
                    isDark ? 'bg-[#12141C] border-white/5 hover:border-white/15' : 'bg-white border-[#FDE8CD] hover:shadow-md'
                  }`}
                >
        ...
        <div className="px-8 py-5 border-t border-zinc-200 dark:border-white/10 flex items-center justify-between gap-4 bg-zinc-50 dark:bg-[#12131A] shrink-0">
          ...
          <button
            onClick={onClose}
            className="px-6 py-2.5 rounded-xl bg-[#EA580C] dark:bg-[#D4FF00] text-white dark:text-black font-black text-xs uppercase tracking-wider hover:scale-105 transition-transform"
          >
            Fermer le Rapport
          </button>
        </div>
