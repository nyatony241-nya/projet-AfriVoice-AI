...
export const COUNTRIES: Country[] = [
  ...
  { id: 'CD', name: 'RD Congo', flag: '🇨🇩', primaryLanguage: 'French', accentDescription: 'Congolese French (Kinshasa) accent. Lingala influence, extremely expressive, singing intonation, punchy consonants, joyful and loud rhythm.', geminiVoiceMale: 'Puck', geminiVoiceFemale: 'Aoede' },
  ...
  { id: 'CG', name: 'Congo Brazzaville', flag: '🇨🇬', primaryLanguage: 'French', accentDescription: 'Brazzaville French accent. Smooth, elegant, Congolese rhythm with a slightly softer delivery than Kinshasa.', geminiVoiceMale: 'Puck', geminiVoiceFemale: 'Aoede' },
